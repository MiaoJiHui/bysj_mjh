...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            <li><a class="add" href="page_2/page1_add.html" target="dialog" mask="true" width="700" height="350" title="新增资产" rel="xinz"><span>新增</span></a></li>
            <li><a class="edit" href="page_2/page1_modify.html?uid={sid_user}" target="dialog"mask="true" width="700" height="350" title="修改资产"warn="请选择一个用户"><span>修改</span></a></li>
            ...
            <li><a class="switch" href="page_2/page1_switch.html" target="dialog" mask="true" width="500" height="200" title="状态变更"  >
                <span style="background:url('/page_2/img/switch1.png') no-repeat 0 3px;">状态变更</span>
                </a>
            </li>
            <li>
                <a class="password" href="page_2/page1_password.html" target="dialog" mask="true" width="600"  height="400" title="密码维护">
                    <span style="background:url('/page_2/img/password.png') no-repeat 0 3px">密码维护</span>
                </a>
            </li>
            <li>
                <a class="import" href="page_2/page1_import.html" target="dialog" mask="true" width="500" height="200" title="密码导入">
                    <span style="background:url('/page_2/img/import.png') no-repeat 0 3px">密码导入</span>
                </a>
            </li>
            <li class="line">line</li>


            <li><a class="icon" href="demo/common/dwz-team.xls" target="dwzExport" targetType="navTab" title="实要导出这些记录吗?">
                <span>导出EXCEL</span></a></li>
            <li>
                <a class="import" href="page_2/page1_import2.html" target="dialog" mask="true" width="500" height="200" title="资产导入">
                    <span style="background:url('/page_2/img/import.png') no-repeat 0 3px">资产导入</span>
                </a>
            </li>
        </ul>
    </div>
