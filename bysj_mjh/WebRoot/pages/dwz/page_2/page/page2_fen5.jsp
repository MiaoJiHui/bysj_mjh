...
<div class="pageContent">
    <form method="post" action="demo/common/ajaxDone.html" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
        <div class="pageFormContent" layoutH="48">
            ...
            <table class="list nowrap itemDetail " width="100%" addbutton="新增" style="clear: both;">
                <thead>
                <tr>
                    <th name="sale[#index#].itemInt" style="width:10%;" type="text" defaultVal="#index#" fieldclass="digits readonly" defaulttext="批次" size="2" readonly="readonly"  size="20" ></th>
                ...
                <tr class="unitBox">
                    <td style="text-align:center">
                        ...
                        <input class="number invoiceNo od textInput readonly " type="text" size="2" value="1" name="sale[0].salesInvoiceSequence" readonly="" style="">
                        </input>
                    </td>
                    <td>
                        <select name="">
