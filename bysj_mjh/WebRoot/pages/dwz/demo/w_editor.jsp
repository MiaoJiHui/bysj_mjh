...
<div
	...
	<div class="tabs">
		...
		<div class="tabsContent" layoutH="100">
			<div>
				<form method="post" action="demo/common/ajaxTimeout.html"
...
upMediaExt:视频本地上传扩展限制 【可选】【默认值： avi】
						...
						<div class="unit">
							<textarea class="editor" name="description" rows="6" cols="100"
								tools="mfull">mfull(多行完全)</textarea>
						</div>
						<div class="unit">
							<textarea class="editor" name="description" rows="6" cols="100"
								tools="simple">simple(简单)</textarea>
						</div>
						<div class="unit">
							<textarea class="editor" name="description" rows="6" cols="100"
								tools="mini">mini(迷你)</textarea>
						</div>
						<div class="unit">
							<textarea class="editor" name="description" rows="6" cols="100"
								tools="Cut,Copy,Paste,Pastetext,|,Source,Fullscreen,About">custom(自定义)</textarea>
						</div>
						<div class="unit">
							<textarea class="editor" name="description" rows="6" cols="100"
								tools="Cut,Copy,Paste,Pastetext,/,Source,Fullscreen,About">自定义多行模式</textarea>
						</div>
					</div>
					<div class="formBar">
						<ul>
