		...
		<div id="login_header">
			<h1 class="login_logo">
				<a href="http://demo.dwzjs.com"><img
					src="themes/default/images/login_logo.gif" />
				</a>
			</h1>
			<div class="login_headerContent">
				<div class="navList">
					<ul>
						...
						<li><a href="http://bbs.dwzjs.com">反馈</a>
						</li>
						<li><a href="doc/dwz-user-guide.pdf" target="_blank">帮助</a>
						</li>
					</ul>
				</div>
		...
		<div id="login_content">
			<div class="loginForm">
				<form action="index.html">
					...
					<p>
						<label>验证码：</label> <input class="code" type="text"
							size="5" /> <span><img
			...
			<div class="login_main">
				...
				<div class="login_inner">
					...
					<p>您还可以使用 闪电邮
						在桌面随时提醒邮件到达，快速收发邮件。</p>
					<p>在 百宝箱
						里您可以查星座，订机票，看小说，学做菜…</p>
				</div>
			</div>
		</div>
